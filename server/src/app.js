...
import subscriptionPortalRoutes from './modules/subscriptions/subscription.portal.routes.js';
...
app.use('/api/internal/vendors', vendorRoutes);
app.use('/api/internal/inventory', inventoryRoutes);
app.use('/api/internal/purchase-orders', purchaseOrderRoutes);
...
app.use('/api/portal', subscriptionPortalRoutes);
